...
from modules.FastDiff.module.WaveNet import swish
...
from modules.parallel_wavegan.layers import ResidualBlock, ResidualBlock_Diffusion
from modules.parallel_wavegan.layers import upsample
from modules.parallel_wavegan import models
from utils.hparams import hparams
import numpy as np

class ParallelWaveGANGenerator_Diffusion(torch.nn.Module):
    ...
    def __init__(self,
        ...
        """
        super(ParallelWaveGANGenerator_Diffusion, self).__init__()
    ...
    def forward(self, x, c=None, pitch=None, f0=None, diffusion_steps=None, **kwargs):
        ...
        for f in self.conv_layers:
            x, h = f(x, c, diffusion_step_embed)
            skips += h
